...
> ✅ **已覆盖**：智能驾驶 / 自动驾驶板块（[→ 进入](./智能驾驶/智能驾驶行业研究.md)），含 5 章主干 + A股/港股/美股 3 个子文件 + 4 张 SVG 图表。它是 AI 上车的「车端 AI」——端到端大模型让智驾从选配变标配，与 L2 芯片 / 存储互补（车端需算力与存储），又拉动 A股零部件（域控/线控/感知硬件）放量。投资上「核心科技（芯片/激光雷达）在港/美，A 股赚域控/线控/座舱/感知放量+国产替代」。

> ✅ **已覆盖**：AI 终端 / 端侧 AI 板块（[→ 进入](./AI终端/AI终端行业研究.md)），含 5 章主干 + A股/港股/美股 3 个子文件 + 4 张 SVG 图表。它是 AI 的「消费侧落地」——AI PC / 手机 / 可穿戴把推理搬到端侧，与 L2 芯片 / 存储互补（端侧需 NPU + 本地存储驻留），又拉动 A股 SoC / CIS / 光学 / 射频 / 代工放量。投资上「SoC / 整机标杆在美 / 港（高通 / 苹果 / 小米），A 股赚 SoC / CIS / 光学 / 射频 / 代工放量 + 国产替代」。
...
>
> ✅ **已覆盖**：CPO 与硅光板块（[→ 进入](./CPO与硅光/CPO与硅光行业研究.md)），含 5 章主干 + A股/港股/美股 3 个子文件 + 4 张 SVG 图表。它是 L4 互联层的「演进形态」——可插拔光模块的下一代（硅光→共封装），与光模块板块互补（now vs next）。投资上「A股赚制造放量（中际/新易盛/天孚），美股买底层布局（博通/Coherent）」，交换芯片（盛科）一并收口 L4 网络层缺口。
...
| CPO 与硅光 | ✅ 已完成 | [→ 行业研究](./CPO与硅光/CPO与硅光行业研究.md)，5 章 + 3 子文件（A股 12 / 港股 0 / 美股 4）+ 4 张 SVG |
...
| 智能驾驶 / 自动驾驶 | ✅ 已完成 | [→ 行业研究](./智能驾驶/智能驾驶行业研究.md)，5 章 + 3 子文件（A股 11 / 港股 6 / 美股 4）+ 4 张 SVG|
| AI 终端 / 端侧 AI | ✅ 已完成 | [→ 行业研究](./AI终端/AI终端行业研究.md)，5 章 + 3 子文件（A股 9 / 港股 4 / 美股 3）+ 4 张 SVG|

---

> **版本**：2026-07-12 · 算力基础设施（部署层）板块已核对（v1.0，neodata 口径）· 存储芯片/HBM 板块已完成（延伸 AI 主线，补全 HBM 缺口）· 人形机器人/具身智能板块已完成（AI 主线向物理世界延伸）· 智能驾驶/自动驾驶板块已完成（AI 上车，车端 AI 落地）· AI 终端/端侧 AI 板块已完成（AI 消费侧落地，SoC/整机标杆在美港、A股赚国产替代）· CPO 与硅光板块已完成（L4 互联层演进形态，收口光互联+交换芯片缺口）· 全链路（芯片→封装→互联→部署→应用）闭环完成
